                ...
                MediaTranscoder.Listener listener = new MediaTranscoder.Listener() {
                    ...
                    public void onTranscodeCompleted() {
                        ...
                        if (saveToLibrary) {
                            ...
                            try {
                                String uri = options.getString("fileUri");
                                File file = new File(uri);
                                file.delete();

                                if(file.exists()){
                                    Log.d("Borrando", "Existe el arhivo a borrar");
                                    file.getCanonicalFile().delete();
                                    if(file.exists()){
                                        Log.d("Borrando", "Archivo eliminado");
                                    appContext.getApplicationContext().deleteFile(file.getName());
                                    }
                                }
                            } catch (Exception ex) {
                                Log.d("Borrando", "" + ex.getMessage());
                            }
                        }
